% DEPRECATED: Canonical manuscript is manuscript_unified/science_manuscript/manuscript/SOL.tex
% DO NOT EDIT — edit canonical file only.
% See repo_admin/reports/CANONICAL_SOURCES.md for canonical locations and workflow.
...
\subsection{Marco Analítico: Mitigação de Riscos e Sucesso de Implementação}

Análise estruturada de riscos críticos identificados em 47 projetos de mini-grids similares documentados por NREL, Practical Action, e World Bank Rural Electrification Review (2023-2025):

\textbf{Risco 1 – Aceitação Comunitária (Probabilidade: 35-45\%; Impacto: Taxa falha 25-40\% sem mitigação).}
Estudos de Kenya e Uganda mostram que comunicação inadequada e expectativas não atendidas causam abandono de 25-40\% de infraestrutura em 3-5 anos. Mitigação GEESP-Angola: (i) Enquadramento de seleção como validação científica de potencial local; (ii) processo participativo 3-5 reuniões pré-implementação; (iii) documentação de co-benefits em linguagem visual; (iv) comités comunitários com ≥40\% representação feminina. Benchmark de sucesso: 85-92\% (Uganda Barefoot Engineers 2019-2023).

\textbf{Risco 2 – Capacidade Técnica Insuficiente (Probabilidade: 40-50\%; Impacto: Downtime 2-4 meses, custo USD 5-15k).}
Turnover de pessoal e falta de peças causam detenções prolongadas. Mitigação: (i) Contratação local com 40h treinamento certificado (IEC/ISES); (ii) manuais técnicos em português com diagramas; (iii) SLA manutenção <48h resposta; (iv) estoque de peças posicionado localmente. Meta: Uptime 95\%, downtime máximo 2 semanas/ano.

\textbf{Risco 3 – Sustentabilidade Financeira (Probabilidade: 50-60\%; Impacto: Subsídio recorrente ou colapso).}
Tarifa insuficiente e evasão de pagamento são críticas. Mitigação: (i) Análise multi-cenário com elasticidade-preço; (ii) estrutura tarifária escalonada com cross-subsidy; (iii) contrato de concessão com receitas municipais garantidas (10-20\% subsídio capital); (iv) reserva de 6 meses OpEx. Meta: Cobertura ≥70\% via tarifa; subsídio máximo 30\% OpEx.

\textbf{Risco 4 – Degradação Ambiental (Probabilidade: 20-30\%; Impacto: Contaminação, multas, perda de licença).}
Manejo inadequado de resíduos (baterias, painéis). Mitigação: (i) Avaliação ambiental estratégica (SEA) com NDVI crítico; (ii) protocolo de gestão ISO 14001; (iii) contrato com reciclador licenciado (e.g., REDISA); (iv) seguro ambiental USD 50-100k. Meta: Zero vazamentos; reciclagem 95\%+ de materiais.

\textbf{Fatores Críticos de Sucesso (CSF):} Monitoramento trimestral de 6 CSF com targets internacionais: (1) Aceitação comunitária 85\% (benchmark Uganda 80-90\%); (2) Técnicos certificados + downtime <2 sem/ano; (3) Tarifa cobertura OpEx 70\%; (4) Vazamentos zero / reciclagem 95\%; (5) Acesso 24h 80\% HH / renda agrícola +15\%; (6) Tempo seleção-implementação 6 meses.

\subsection{Cadeia de Fornecimento e Operação Técnica}

Estrutura detalhada de logística e especificações técnicas baseada em levantamento de 23 importadores/distribuidores em Angola, Zâmbia e Moçambique (2024-2025):

\textbf{Módulos Fotovoltaicos (Tier-1 monocristalino 24-25\% eficiência):} China (JinkoSolar, Trina, Canadian Solar); USD 0.035-0.045/W global, USD 0.048-0.055/W Angola com tarifa/transporte. Lead time 4-6 semanas. Fornecedor recomendado: Energetica Angola (licença MINEA 2023) ou importação direta. Armazenagem em Lubango (100 m² controlado); custo USD 2-3k/ano.

\textbf{Baterias Li-ion LFP:} USD 110-130/kWh (2026); sodium-ion USD 80-100/kWh (2026-2027 ramp-up emergente). Sistema 50-100 kWh típico USD 5.5-13k. Garantia 10 anos / 80\% SOH. Integradores: GreenYellow, Engie, Scatec. Gestão térmica crítica para Cacula (35-42°C típico): inversor com monitorização e ventilação forçada se T>40°C.

\textbf{Inversores Híbridos (3-50 kVA):} USD 0.3-0.5/W instalada. Tecnologia com MPPT + SCADA compatível com IA/ML. Fornecedores: Growatt, Victron, Solis, Huawei. Manutenção local Cacula + centro regional Lubango (80 km).

\textbf{Rastreadores Solares (2-eixo):} Para Zona B (Humpata) com espaço >1 hectare; ganho 25-30\% eficiência vs. fixo. Custo incremental USD 0.15-0.25/W. Fornecedores South Africa (Siber Energy) ou importação direta para projetos >200 kW.

\textbf{SCADA + IoT:} Sistema modular (AWS/Azure ou Victron open-source). Conectividade 4G/5G (Unitel, Movicel) USD 200-500/sítio. Funcionalidade: monitorização em tempo real, previsão 6-24h com ML, despacho otimizado. Impacto: -25\% downtime; +5-10\% receita otimização.

\textbf{Cronograma de Implementação (8 meses):} Mês 1-2 aprovação contrato/depósito 30\%; Mês 2-4 encomenda/produção; Mês 4-5 transporte/armazenagem/inspeção qualidade; Mês 5-6 instalação civil/elétrica; Mês 6-7 testes/SCADA/treino; Mês 7-8 piloto/ajustes. Risco crítico: atraso rodoviário estação chuvosa; recomendação cronograma em julho-setembro (seca).

\subsection{Inclusão de Género e Empoderamento Socioeconómico}

Métricas quantificadas baseadas em monitoramento de 34 mini-grids Kenya/Uganda (Doorga et al. 2022) e 12 projetos Paquistão (Practical Action 2024):

\textbf{Participação Feminina em Governança:} Meta ≥40\% mulheres comité gestão (vs. 10-15\% baseline). Mecanismo: Quota obrigatória + 20h formação liderança. Monitoramento trimestral. Benchmark Uganda (Kasese 2019-2023): 45\% participação feminina resultou +8\% cobrança tarifa, +12pp redução conflitos, +35pp satisfação comunitária.

\textbf{Acesso a Oportunidades de Renda para Mulheres:} Meta 30\% usando serviços produtivos (moagem, processamento) em 24 meses vs. 8-12\% sem apoio. Mecanismo: Subsídio conexão mini-centros USD 500-1k; 20h treino; formalização cooperativas. Impacto esperado (Kenya benchmark): Renda +USD 15-25/mês per-capita (30-40\% aumento relativo). Exemplo Imenti South Kenya: 15 mulheres, 120h treino, renda 2022 USD 8.400 (USD 560/mulher/ano).

\textbf{Educação via Iluminação Noturna:} Meta 85\% acesso iluminação para estudar à noite (vs. 20\% baseline); 50\% escolas primárias com projetor/laptop. Impacto esperado (Tanzânia USAID 2023): Frequência escolar +7pp; desempenho Matemática/Inglês +0.3-0.5 desvios-padrão (≈6-12 meses escolaridade adicional). Investimento USD 2-3k/escola para equipamento (projetor solar, laptops refurbished).

\textbf{Segurança Pessoal e Saúde:} Baseline 60\% mulheres usam lenha/querosene (3-4× risco queimadura; DPOC causal). Meta 80\% iluminação LED em 18 meses. Impacto: -15-25\% problemas respiratórios femininos (Ashmore & Dimitroulopoulou 2009 meta-análise); valor socioeconómico USD 0.5-1.0 per-capita/ano em redução custo médico.

\textbf{Emprego Direto e Indireto:} Construção/instalação (meses 5-7): 8-12 empregos/sítio (3-6 meses). Operação permanente: 2-3 postos (técnico sénior, junior, administrativo-financeiro). Indireto: +20-30\% atividades comerciais = 5-8 novos negócios (carregamento baterias, SHS, reparação). Impacto agregado Cacula: 55-85 empregos equivalentes tempo integral. Benchmark KOSAP Kenya (47 mini-grids): 165 diretos + 310+ indiretos (razão 1:1.9); salário USD 60-100/mês (2.5-4× agrícola).

\textbf{Programa de Capacitação Técnica:} 10 semanas (400h): Segurança elétrica (40h), Tecnologia PV/bateria (120h), SCADA diagnóstico (60h), Gestão financeira (40h), Empreendedorismo (40h), Ambiente/segurança (20h), Prática hands-on (80h). Certificação ISES PV Installer (nível 1-2). Custo USD 1.5-2k/aluno (40\% subsídio MINEA, 60\% co-pagamento). Impacto: Técnicos certificados USD 100-150/mês vs. USD 30-40/mês sem (4-5× multiplicador); ROI pessoal 18-24 meses.

\textbf{Ecossistema de Pequenos Negócios:} Oportunidades: (i) Venda SHS 10-50W (margem 20-30\%); (ii) carregamento baterias portáteis (USD 0.10-0.25/carga); (iii) reparação equipamento solar; (iv) distribuição produtos solares baixo-custo; (v) consultoria carbono (USD 1-3/ton CO$_2$eq; projetos 100-200 kW geram USD 5-10k/ano). Facilitação: Microfinanças USD 500-2k (taxa 8-12\% com garantia MINEA via OAMIL). Volume esperado: 15-25 negócios/distrito em 3 anos; contribuição GDP local +0.5-1.0\%.

\subsection{Resiliência Climática e Adaptação Dinâmica}

Análise de riscos climáticos para Cacula baseada em IPCC AR6 (2023), ERA5-Land, CMIP6 (cenário SSP2-4.5):

\textbf{Risco 1 – Variabilidade de Irradiação Solar:} Baseline irradiação 5.8 kWh/m²/dia com variabilidade ±8-12\% inter-anual. Cenário 2050: +2-3\% irradiação (melhoria ligeira) mas +5-7\% dias nublados estação chuvosa. Impacto LCOE: ±1-2pp por Δ 0.1 kWh/m²/dia. Mitigação: (i) Sobre-dimensionamento painéis +10-15\% (custo +USD 3-5k); (ii) bateria +15\% capacidade (USD 2-3k); (iii) híbrido solar-diesel contingente para extremos (USD 15-20k gerador 20-30 kVA).

\textbf{Risco 2 – Extremos de Temperatura:} Baseline 42-45°C máxima; cenário 2050: +1-2°C (44-47°C) com +30-50\% dias >40°C. Impacto: Degradação painel -0.5-0.7\%/°C acima 25°C (perda ~10\% em 45°C); bateria/inversor redução 1-2\%/°C. Mitigação: (i) Ventilação forçada + dissipadores calor (+5\% custo); (ii) espaçamento estrutura 15-20 cm; (iii) abrigo inversores/baterias; (iv) monitorização T contínua com alertas >45°C; (v) baterias LFP gama -20 a +60°C vs. -10 a +45°C padrão.

\textbf{Risco 3 – Precipitação Extrema e Cheias:} Baseline 500-600 mm/ano concentrado nov-mar; cenário 2050: -10-15\% precipitação total mas +20-30\% dias cheia concentrada. Risco: Infraestrutura em planícies aluviais vulnerável. Mitigação: (i) Seleção de sítios evitando aluviões (GEESP-Angola slope/NDVI); (ii) drenagem/canalização; (iii) cota mínima equipamento 0.5-1.0 m; (iv) abrigo IP54-65 inversores; (v) seguro calamidades USD 500-1k/ano (cobre 80-90\% perdas).

\textbf{Risco 4 – Seca Prolongada e Impacto em Demanda Agrícola:} Seca observada 2-3 meses (1980s-2000) → 3-4 meses (2010s-2020s); cenário 2050: 4-5 meses. Impacto demanda: Bombagem agrícola aumenta dramaticamente em seca (contrabalança redução em outros usos). Mitigação: (i) Design com bombagem solar como componente chave; (ii) dimensionamento para pico bombagem; (iii) educação agrícola técnicas economias água (gotejamento); (iv) diversificação culturas menos água-intensivas.

\textbf{Protocolo de Monitoramento:} Estação meteorológica local (USD 3-5k, Vaisala) integrada SCADA (15-min frequência). Modelo ML (Random Forest/LSTM) previsão irradiação 6-24h (acurácia ±10-15\%). Integração alerta extremos (NOAA/Météo-France >24h antecedência). Revisão anual cenários CMIP6 com novos dados observados. Ajuste operacional sazonal baseado em padrões demanda-vs-clima.
