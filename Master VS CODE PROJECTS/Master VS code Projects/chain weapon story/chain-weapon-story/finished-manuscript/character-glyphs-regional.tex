...
\newcommand{\GlyphCaspianWestCalm}{\begin{tikzpicture}[x=1cm,y=1cm,line cap=round]\draw[line width=0.6pt] (0.2,1.0) -- (1.0,0.5) -- (1.8,1.0);\draw[line width=0.6pt] (0.2,1.0) -- (1.0,1.5) -- (1.8,1.0);\end{tikzpicture}}
\newcommand{\GlyphCaspianEastCalm}{\begin{tikzpicture}[x=1cm,y=1cm,line cap=round]\draw[line width=0.5pt] (1.0,0.2) arc(270:90:0.7);\draw[line width=0.5pt] (1.0,0.2) arc(270:450:0.7);\draw[line width=0.4pt] (0.7,1.0) -- (1.3,1.0);\draw[line width=0.4pt] (0.5,1.0) -- (1.5,1.0);\end{tikzpicture}}
