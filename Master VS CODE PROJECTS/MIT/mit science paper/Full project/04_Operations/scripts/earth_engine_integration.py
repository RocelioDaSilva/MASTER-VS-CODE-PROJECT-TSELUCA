...
class EarthEngineIntegration:
    ...
    # Pre-defined regions (can be extended)
    REGIONS = {
        'angola': {
            'bounds': ee.Geometry.Rectangle([-5.92, 11.20, 24.10, -4.38]),
            'region_name': 'Angola',
            'description': 'Angola national boundary'
        },
        'luanda': {
            'bounds': ee.Geometry.Rectangle([13.20, 8.80, 13.60, 8.40]),
            'region_name': 'Luanda Province',
            'description': 'Luanda Province'
        },
        'huambo': {
            'bounds': ee.Geometry.Rectangle([15.70, 12.90, 16.20, 12.40]),
            'region_name': 'Huambo Province',
            'description': 'Huambo Province'
        },
        'benguela': {
            'bounds': ee.Geometry.Rectangle([13.20, 13.60, 14.40, 12.20]),
    ...
    DATASETS = {
        'solar_irradiance': {
            'collection': 'NOAA/GFSANL',
            'band': 'DSWRF_surface',
            'description': 'Global Forecast System solar irradiance'
        },
        'elevation': {
            'collection': 'USGS/SRTMGL1_Ellip/SRTM30',
            'band': 'elevation',
            'description': 'SRTM 30m DEM - Elevation'
        },
        'land_cover': {
            'collection': 'COPERNICUS/Lc100/LCQS/timmulticov',
            'band': 'lc',
