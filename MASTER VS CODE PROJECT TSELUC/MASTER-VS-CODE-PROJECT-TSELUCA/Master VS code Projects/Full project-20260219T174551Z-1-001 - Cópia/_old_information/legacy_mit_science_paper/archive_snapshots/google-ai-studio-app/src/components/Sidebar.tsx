...
import { Settings, Zap, Map as MapIcon, DollarSign, Info } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ weights, setWeights, params, setParams }) => {
  return (
    <div className="w-80 h-screen bg-zinc-950 border-r border-emerald-900/30 text-zinc-100 flex flex-col overflow-y-auto">
