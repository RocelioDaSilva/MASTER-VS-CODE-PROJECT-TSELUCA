...
class PetroChampPlatform:
    ...
    def _create_dashboard_tab(self):
        ...
        tk.Label(title_frame, text="Versão completa com 7 métodos EOR, análise econômica e sistema de justificações", 
    ...
    def show_score_chart(self):
        ...
        try:
            ...
            canvas.draw()
            canvas.get_tk_widget().pack(fill='both', expand=True)  # CORREÇÃO AQUI
