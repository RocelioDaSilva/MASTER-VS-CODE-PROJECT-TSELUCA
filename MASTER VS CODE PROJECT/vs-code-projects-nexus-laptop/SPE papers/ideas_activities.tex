...
\usepackage{tikz}
\usepackage{adjustbox}   % For better scaling of large tikz pictures
\usepackage{parskip}     % Consistent paragraph spacing
...
\begin{itemize}
    \item Modelagem de reservatórios usando software como Eclipse.
    \item Análise de impacto ambiental de derrames.
    \item Desenvolvimento de apps para monitoramento de produção.
\end{itemize}
...
\begin{itemize}
    \item Construa portfólio com projetos pessoais.
    \item Aprenda idiomas: Inglês e português são essenciais.
    \item Envolva-se em SPE desde cedo para networking.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Posições de Entrada:} Engenheiro de Reservatórios Junior, Engenheiro de Produção Assistente.
    \item \textbf{Especializações:} Modelagem de reservatórios, otimização de produção, exploração offshore.
    \item \textbf{Caminhos para Avançar:} Estágios em Sonangol, certificações SPE, mestrado em Engenharia Petrolífera.
    \item \textbf{Salários Iniciais:} 70.000-90.000 Kz.
    \item \textbf{Oportunidades:} Trabalhar em campos como Girassol ou Kaombo.
\end{itemize}

\subsubsection{Geofísica}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Geofísico Assistente, Analista de Dados Sísmicos.
    \item \textbf{Especializações:} Interpretação sísmica, geologia de petróleo, modelagem geofísica.
    \item \textbf{Caminhos para Avançar:} Cursos em software como Petrel, participação em projetos de exploração.
    \item \textbf{Salários Iniciais:} 60.000-80.000 Kz.
    \item \textbf{Oportunidades:} Colaboração com empresas como Chevron para mapeamento de reservatórios.
\end{itemize}

\subsubsection{Engenharia Química}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Engenheiro de Processos Junior, Especialista em Refino.
    \item \textbf{Especializações:} Refino de petróleo, tratamento de efluentes, química de polímeros.
    \item \textbf{Caminhos para Avançar:} Estágios em refinarias, certificações em segurança química.
    \item \textbf{Salários Iniciais:} 65.000-85.000 Kz.
    \item \textbf{Oportunidades:} Trabalhar em Luanda Refinery ou projetos de CCUS.
\end{itemize}

\subsubsection{Engenharia Mecânica}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Engenheiro de Manutenção, Projetista de Equipamentos.
    \item \textbf{Especializações:} Manutenção de plataformas, design de bombas e válvulas.
    \item \textbf{Caminhos para Avançar:} Cursos em CAD, experiência em offshore.
    \item \textbf{Salários Iniciais:} 60.000-80.000 Kz.
    \item \textbf{Oportunidades:} Suporte técnico em campos petrolíferos.
\end{itemize}

\subsubsection{Engenharia de Produção Industrial}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Analista de Produção, Coordenador de Operações.
    \item \textbf{Especializações:} Otimização de processos industriais, gestão de supply chain.
    \item \textbf{Caminhos para Avançar:} Certificações Lean/Six Sigma, projetos de eficiência.
    \item \textbf{Salários Iniciais:} 55.000-75.000 Kz.
    \item \textbf{Oportunidades:} Gestão de operações em refinarias ou plataformas.
\end{itemize}

\subsubsection{Engenharia Eletrotécnica}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Engenheiro Elétrico Junior, Especialista em Automação.
    \item \textbf{Especializações:} Sistemas elétricos offshore, controle de processos.
    \item \textbf{Caminhos para Avançar:} Cursos em SCADA, experiência em energia renovável.
    \item \textbf{Salários Iniciais:} 60.000-80.000 Kz.
    \item \textbf{Oportunidades:} Manutenção elétrica em instalações petrolíferas.
\end{itemize}

\subsubsection{Engenharia Informática}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Desenvolvedor de Software, Analista de Dados.
    \item \textbf{Especializações:} IA para exploração, desenvolvimento de apps para monitoramento.
    \item \textbf{Caminhos para Avançar:} Projetos em Python/R, certificações em data science.
    \item \textbf{Salários Iniciais:} 70.000-90.000 Kz.
    \item \textbf{Oportunidades:} Inovação digital em empresas como TotalEnergies.
\end{itemize}

\subsubsection{Engenharia Civil}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Engenheiro de Construção, Projetista de Infraestrutura.
    \item \textbf{Especializações:} Construção offshore, gestão de projetos.
    \item \textbf{Caminhos para Avançar:} Certificações PMP, experiência em projetos grandes.
    \item \textbf{Salários Iniciais:} 55.000-75.000 Kz.
    \item \textbf{Oportunidades:} Construção de plataformas e pipelines.
\end{itemize}

\subsubsection{Contabilidade}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Contador Junior, Analista Financeiro.
    \item \textbf{Especializações:} Contabilidade de custos petrolíferos, auditoria energética.
    \item \textbf{Caminhos para Avançar:} Certificações CPA, experiência em compliance.
    \item \textbf{Salários Iniciais:} 50.000-70.000 Kz.
    \item \textbf{Oportunidades:} Gestão financeira em empresas estatais.
\end{itemize}

\subsubsection{Economia}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Economista Assistente, Analista de Mercado.
    \item \textbf{Especializações:} Economia energética, modelagem econômica de projetos.
    \item \textbf{Caminhos para Avançar:} Mestrado em Economia, participação em estudos de viabilidade.
    \item \textbf{Salários Iniciais:} 55.000-75.000 Kz.
    \item \textbf{Oportunidades:} Análise de investimentos em Angola LNG.
\end{itemize}

\subsubsection{Gestão Empresarial}
\begin{itemize}
    \item \textbf{Posições de Entrada:} Gestor de Projetos Junior, Coordenador Administrativo.
    \item \textbf{Especializações:} Gestão de operações petrolíferas, estratégia corporativa.
    \item \textbf{Caminhos para Avançar:} MBA, certificações em liderança.
    \item \textbf{Salários Iniciais:} 60.000-80.000 Kz.
    \item \textbf{Oportunidades:} Coordenação em joint ventures.
\end{itemize}
...
\begin{itemize}
    \item Planejamento: 6 meses de antecedência, com equipe de 10 membros.
    \item Execução: Seminários, painéis e feira de empregos.
    \item Resultados: 200 conexões estabelecidas, 30\% dos participantes conseguiram estágios.
    \item Desafios: Coordenação logística; solução: Uso de ferramentas online como Eventbrite.
\end{itemize}
...
\begin{itemize}
    \item Objetivo: Educar sobre transição energética.
    \item Recursos: Palestrantes de MIREMPET, materiais impressos.
    \item Métricas: 80\% de feedback positivo, 20 novos membros recrutados.
    \item Impacto: Colaboração com governo para projetos futuros.
\end{itemize}
...
\begin{itemize}
    \item Plataforma: Kuenda ou GoFundMe.
    \item Meta: 500.000 Kz para laboratório virtual.
    \item Recompensas: Merchandise personalizado.
    \item Resultados Esperados: Alcance de 1.000 apoiadores, sustentabilidade financeira.
\end{itemize}
...
\begin{itemize}
    \item Ano 1: Estágio em exploração, aprendizado de software.
    \item Ano 2: Projeto de otimização, publicação em revista SPE.
    \item Ano 3: Liderança em equipe, mentoria para novos.
    \item Dicas: Construa rede, invista em certificações.
\end{itemize}
...
\begin{itemize}
    \item Troca de conhecimento, networking global.
    \item Custos baixos: Uso de Zoom gratuito.
    \item Impacto: Parcerias para projetos futuros, aumento de membresia em 25\%.
\end{itemize}
...
\begin{itemize}
    \item Coleta de dados: Fontes EIA e MIREMPET.
    \item Análise: Software Python para simulação.
    \item Resultados: Recomendações para eficiência energética.
    \item Lições: Colaboração interdisciplinar, publicação em JPT.
\end{itemize}
...
\begin{itemize}
    \item Transição rápida: Treinamento em ferramentas digitais.
    \item Manutenção de comunidade: Reuniões semanais.
    \item Resultados: Retenção de 90\% dos membros, arrecadação estável.
\end{itemize}
...
\begin{itemize}
    \item Sessões de mentoria, painéis com líderes femininas.
    \item Parcerias com organizações como Women in Energy.
    \item Impacto: Carreiras avançadas para participantes.
\end{itemize}
...
\begin{itemize}
    \item IA e Machine Learning: Para predição de reservatórios.
    \item Digital Twins: Modelos virtuais de campos.
    \item Blockchain: Para transparência em contratos.
\end{itemize}
...
\begin{itemize}
    \item Metas: 50\% renováveis até 2040.
    \item Oportunidades: Hidrogênio verde, CCUS.
    \item Desafios: Dependência de petróleo.
\end{itemize}
...
\begin{enumerate}
    \item Definir tema e data.
    \item Convidar palestrantes.
    \item Promover via redes.
    \item Coletar feedback.
\end{enumerate}

\subsubsection{Timeline}
\begin{itemize}
    \item Mês 1: Planejamento.
    \item Mês 2: Execução.
    \item Mês 3: Avaliação.
\end{itemize}

\subsection{Plano de Fundraising}
\begin{enumerate}
    \item Identificar fontes.
    \item Criar orçamento.
    \item Executar campanhas.
    \item Rastrear arrecadação.
\end{enumerate}
...
\begin{enumerate}
    \item Avaliar necessidades.
    \item Oferecer treinamentos.
    \item Facilitar networking.
    \item Medir progresso.
\end{enumerate}

\subsubsection{Métricas}
\begin{itemize}
    \item Satisfação: Surveys.
    \item Engajamento: Participação em eventos.
\end{itemize}
...
\begin{itemize}
    \item WhatsApp: Grupos.
    \item Slack: Colaboração.
    \item Zoom: Reuniões virtuais.
\end{itemize}
...
\begin{itemize}
    \item Google Workspace: Docs, Sheets.
    \item Trello: Gerenciamento de tarefas.
    \item Canva: Design gráfico.
\end{itemize}
...
\begin{itemize}
    \item Coursera: Cursos SPE.
    \item Khan Academy: Básicos de engenharia.
    \item SPE Connect: Rede profissional.
\end{itemize}
...
\begin{itemize}
    \item GoFundMe: Crowdfunding.
    \item Eventbrite: Vendas de ingressos.
    \item PayPal: Pagamentos.
\end{itemize}
...
\subsection{Resumo}
\begin{itemize}
    \item Atividades: Diversificadas e impactantes.
    \item Fundos: Estratégias múltiplas.
    \item Estratégias: Foco em sucesso sustentável.
    \item Angola: Contexto rico em oportunidades.
    \item Estudantes: Carreiras promissoras.
\end{itemize}
...
\begin{enumerate}
    \item Definir tema: Baseado em necessidades dos membros.
    \item Selecionar palestrante: Profissional da indústria.
    \item Logística: Local, data, promoção.
    \item Execução: Apresentações, Q\&A.
    \item Avaliação: Surveys para feedback.
\end{enumerate}

\subsubsection{Dicas Avançadas}
\begin{itemize}
    \item Use ferramentas como Mentimeter para interatividade.
    \item Registre sessões para YouTube.
    \item Seguir código de conduta SPE.
\end{itemize}

\subsection{Guia para Fundraising Online}
\begin{enumerate}
    \item Escolher plataforma: GoFundMe.
    \item Criar campanha: Vídeo, descrição.
    \item Promover: Redes sociais, emails.
    \item Atualizar apoiadores: Progresso semanal.
    \item Entregar recompensas: Merchandise.
\end{enumerate}

\subsubsection{Estratégias de Marketing}
\begin{itemize}
    \item Hashtags: \verb|#SPEAngola| \verb|#EnergiaSustentavel|
    \item Parcerias: Influenciadores locais.
    \item Metas realistas: 100.000 Kz iniciais.
\end{itemize}

\subsection{Guia para Networking}
\begin{enumerate}
    \item Participar em eventos SPE.
    \item Preparar elevator pitch.
    \item Seguir profissionais no LinkedIn.
    \item Oferecer ajuda: Voluntariado.
    \item Manter contato: Emails de follow-up.
\end{enumerate}
...
\begin{itemize}
    \item 2020: 1,1 milhões bpd
    \item 2021: 1,0 milhões bpd
    \item 2022: 1,2 milhões bpd
    \item 2023: 1,2 milhões bpd
    \item 2024: 1,3 milhões bpd
    \item 2025 (proj.): 1,4 milhões bpd
\end{itemize}
Fonte: EIA.
...
\begin{itemize}
    ...
    \item Outros: 7,2 bilhões barris
\end{itemize}

\subsection{Emprego na Indústria}
\begin{itemize}
    \item Total empregados: 50.000
    \item Técnicos: 10.000
    \item Engenheiros: 5.000
    \item Taxa de crescimento: 3\% ao ano
\end{itemize}
...
\begin{itemize}
    \item Adaptabilidade: Use tecnologia.
    \item Inclusão: Programas para minorias.
    \item Sustentabilidade: Grants locais.
\end{itemize}
...
\begin{itemize}
    \item "Petroleum Engineering Handbook" (SPE)
    \item "Energy Transition in Africa" (OUP)
    \item "Sustainable Oil and Gas" (Wiley)
\end{itemize}

\subsection{Sites Úteis}
\begin{itemize}
    \item spe.org: Publicações e eventos.
    \item eia.gov: Dados globais.
    \item mirempet.gov.ao: Regulamentações angolanas.
\end{itemize}

\subsection{Comunidades Online}
\begin{itemize}
    \item Reddit: r/PetroleumEngineering
    \item LinkedIn: Grupos SPE Angola
    \item Discord: Servidores de estudantes.
\end{itemize}
...
\begin{itemize}
    ...
    \item Perguntas:
      \begin{enumerate}
        \item Em uma escala de 1 a 5, quão satisfeito você está com o evento? (1=Muito Insatisfeito, 5=Muito Satisfeito)
        \item O que você aprendeu? (Aberta)
        \item Sugestões para melhoria: (Aberta)
        \item Você participaria novamente? (Sim/Não)
      \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item Avaliação:
      \begin{enumerate}
        \item Clareza da apresentação: 1-5
        \item Relevância do conteúdo: 1-5
        \item Interação com audiência: 1-5
        \item Comentários: (Aberta)
      \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Perguntas:
      \begin{enumerate}
        \item Você se sente engajado no capítulo? (1-5)
        \item Quais atividades você mais gosta? (Múltipla escolha: Seminários, Workshops, Networking)
        \item Sugestões para novas atividades: (Aberta)
        \item Frequência ideal de eventos: (Semanal, Mensal, Trimestral)
      \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item Perguntas:
      \begin{enumerate}
        \item Antes do evento, seu conhecimento sobre [tema] era: 1-5
        \item Após o evento: 1-5
        \item Você aplicará o aprendido? (Sim/Não, Por quê?)
      \end{enumerate}
\end{itemize}
...
\begin{enumerate}
    \item Elaborar estatutos.
    \item Submeter ao ministério.
    \item Obter CNPJ ou equivalente.
\end{enumerate}
...
\begin{itemize}
    \item Seguir código de ética SPE.
    \item Relatórios anuais à SPE International.
\end{itemize}
...
\begin{itemize}
    \item Responsabilidade por acidentes em visitas.
...
\begin{itemize}
    \item Consultar advogado local.
    \item Guias SPE online.
    \item Workshops sobre compliance.
\end{itemize}
...
\begin{itemize}
    \item Eventos temáticos.
    \item Mentoria para minorias.
\end{itemize}
...
\begin{itemize}
    \item Orçamentos detalhados.
    \item Comunicação com doadores.
\end{itemize}
...
\subsubsection{Aplicação em Angola}
\begin{itemize}
    \item Usar ferramentas acessíveis.
\end{itemize}
...
\begin{itemize}
    \item Focar em comunidades rurais.
\end{itemize}
...
\begin{itemize}
    \item Predição de manutenção.
    \item Redução de custos em 30\%.
\end{itemize}

\subsection{Economia Circular}
\begin{itemize}
    \item Reutilização de resíduos petrolíferos.
\end{itemize}

\subsection{Transição Justa}
\begin{itemize}
    \item Treinamento para trabalhadores deslocados.
\end{itemize}

\subsection{Investimentos em Angola}
\begin{itemize}
    \item 50 bilhões USD em renováveis até 2035.
\end{itemize}

\subsection{Role da SPE}
\begin{itemize}
    \item Liderar educação em novas tecnologias.
\end{itemize}
...
\begin{itemize}
    \item "Oil and Gas Production Handbook" (ABB)
    \item "Sustainable Energy" (Oxford)
    \item "Petroleum Economics" (Wiley)
\end{itemize}

\subsection{Sites Adicionais}
\begin{itemize}
    \item worldbank.org: Dados econômicos.
    \item un.org: Sustentabilidade global.
    \item angola.gov.ao: Políticas locais.
\end{itemize}

\subsection{Ferramentas Adicionais}
\begin{itemize}
    \item GitHub: Códigos open-source para simulações.
    \item Tableau: Visualização de dados.
    \item Slack: Comunicação avançada.
\end{itemize}

\subsection{Comunidades Adicionais}
\begin{itemize}
    \item Facebook Groups: SPE Students Worldwide
    \item YouTube: Canais de engenharia petrolífera
    \item Podcasts: "Energy Insights"
\end{itemize}
...
\begin{itemize}
    \item Data: 15 de Janeiro
    \item Duração: 2 horas
    \item Local: Auditório ISPTEC
    \item Responsáveis: Presidente, Vice-Presidente
    \item Checklist:
      \begin{itemize}
        \item Convidar membros antigos e novos via WhatsApp.
        \item Preparar apresentações sobre objetivos.
        \item Distribuir materiais de boas-vindas.
      \end{itemize}
    \item Pós-evento: Enviar fotos e resumo.
\end{itemize}

\subsubsection{Seminário de Boas-Vindas}
\begin{itemize}
    \item Data: 30 de Janeiro
    \item Duração: 3 horas
    \item Palestrante: Eng. João Silva (Sonangol)
    \item Checklist:
      \begin{itemize}
        \item Confirmar presença do palestrante.
        \item Promover nas redes sociais.
        \item Preparar certificados.
      \end{itemize}
    \item Métricas: Coleta de feedback imediata.
\end{itemize}

\subsubsection{Atividade de Networking}
\begin{itemize}
    \item Data: 15 de Fevereiro
    \item Duração: 1.5 horas
    \item Atividades: Jogos de gelo, discussões.
    \item Checklist:
      \begin{itemize}
        \item Comprar snacks.
        \item Planejar jogos.
      \end{itemize}
    \item Resultados: Aumento de interações.
\end{itemize}

\subsubsection{Workshop de Liderança}
\begin{itemize}
    \item Data: 28 de Fevereiro
    \item Duração: 2 horas
    \item Facilitador: Membro experiente.
    \item Checklist:
      \begin{itemize}
        \item Materiais online.
        \item Avaliação pré e pós.
      \end{itemize}
\end{itemize}

\subsubsection{Campanha de Recrutamento Online}
\begin{itemize}
    \item Data: Todo o mês
    \item Checklist:
      \begin{itemize}
        \item Postar diariamente.
        \item Rastrear seguidores.
      \end{itemize}
\end{itemize}

\subsubsection{Parceria com Outros Clubes}
\begin{itemize}
    \item Data: 15 de Março
    \item Duração: 1 hora
    \item Virtual.
    \item Checklist:
      \begin{itemize}
        \item Coordenar com outros capítulos.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Datas: 10 de Abril, 15 de Maio, 20 de Junho
    \item Temas: Exploração, Sustentabilidade, Tecnologias.
    \item Checklist:
      \begin{itemize}
        \item Selecionar palestrantes.
        \item Preparar slides.
        \item Gravar sessões.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Checklist:
      \begin{itemize}
        \item Obter permissões.
        \item Organizar transporte.
        \item Seguro.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Checklist:
      \begin{itemize}
        \item Agendar palestrantes internacionais.
      \end{itemize}
\end{itemize}

\subsubsection{Projeto de Pesquisa Estudantil}
\begin{itemize}
    \item Data: Todo o trimestre
    \item Checklist:
      \begin{itemize}
        \item Formar grupos.
        \item Supervisionar.
...
\begin{itemize}
    \item Data: 30 de Junho
    \item Checklist:
      \begin{itemize}
        \item Convidar empresas.
        \item Preparar CVs.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Data: 20 de Junho
    \item Checklist:
      \begin{itemize}
        \item Materiais de proteção.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Checklist:
      \begin{itemize}
        \item Visitas a universidades.
      \end{itemize}
\end{itemize}

\subsubsection{Projeto Comunitário}
\begin{itemize}
    \item Data: 15 de Agosto
    \item Checklist:
      \begin{itemize}
        \item Parcerias com ONGs.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Data: 10 de Julho
    \item Checklist:
      \begin{itemize}
        \item Local ao ar livre.
      \end{itemize}
\end{itemize}

\subsubsection{Treinamento em Soft Skills}
\begin{itemize}
    \item Data: 25 de Julho
    \item Checklist:
      \begin{itemize}
        \item Jogos interativos.
      \end{itemize}
\end{itemize}

\subsubsection{Colaboração com Indústria}
\begin{itemize}
    \item Data: 5 de Setembro
    \item Checklist:
      \begin{itemize}
        \item Agendamento.
      \end{itemize}
...
\begin{itemize}
    \item Data: 25 de Novembro
    \item Checklist:
      \begin{itemize}
        \item Contato com ex-membros.
      \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Pergunta: Como estudantes podem se preparar?
    \item Resposta: Foque em habilidades técnicas e networking.
\end{itemize}

\subsection{Entrevista com Dr. António Lopes (MIREMPET)}
\begin{itemize}
    \item Pergunta: Tendências em Angola?
    \item Resposta: Sustentabilidade e diversificação.
\end{itemize}

\subsection{Entrevista com Prof. Ana Pereira (ISPTEC)}
\begin{itemize}
    \item Pergunta: Role do capítulo?
    \item Resposta: Preparar para indústria.
\end{itemize}
...
Mais dados.
\begin{itemize}
    \item Produção até 2030: 2 milhões bpd.
    \item Investimentos: 100 bilhões USD.
    \item Empregos verdes: 50.000 até 2035.
\end{itemize}
...
Dicas detalhadas.
\begin{itemize}
    \item Currículo: Incluir projetos SPE.
    \item Entrevistas: Pratique perguntas comuns.
    \item Networking: Use LinkedIn.
\end{itemize}
...
\begin{itemize}
    \item Energia: Eventos virtuais.
    \item Finanças: Fundo de reserva.
    \item Ambiental: Reduzir papel.
\end{itemize}
...
\begin{itemize}
    \item Coleta de dados: Fontes primárias (entrevistas) e secundárias (relatórios).
    \item Análise: Uso de ferramentas como Python para estatísticas, GIS para mapeamento.
    \item Ética: Garantir consentimento e confidencialidade.
\end{itemize}
...
\begin{itemize}
    \item Grants SPE: Até USD 5.000 para projetos inovadores.
    \item Bolsas governamentais: MIREMPET para energia sustentável.
    \item Crowdfunding: Plataformas para arrecadar fundos.
\end{itemize}

\subsection{Desafios e Soluções em Pesquisa}
\begin{itemize}
    \item Acesso a dados: Solução: Parcerias com governo.
    \item Falta de equipamentos: Solução: Usar simulações virtuais.
    \item Publicação: Solução: Submeter para JPT ou conferências SPE.
\end{itemize}
...
\begin{itemize}
    \item 2023: 5 derrames maiores, afetando 100km² de oceano.
    \item Biodiversidade: 20\% de espécies marinhas ameaçadas.
\end{itemize}
...
\begin{itemize}
    \item Emprego: 50.000 diretos, mas subemprego alto.
    \item Pobreza: 30\% da população ainda em pobreza extrema.
\end{itemize}
...
\begin{itemize}
    \item Educar estudantes sobre ESG.
    \item Organizar eventos de conscientização.
    \item Colaborar com ONGs.
\end{itemize}

\subsubsection{Métricas de Sucesso}
\begin{itemize}
    \item Redução de pegada: 20\% em eventos do capítulo.
    \item Engajamento: 50+ participantes em workshops ambientais.
\end{itemize}
...
\begin{itemize}
    \item 2023: 90\% das exportações, 30\% do PIB.
    \item Receitas: 35 bilhões USD anuais.
\end{itemize}
...
\subsubsection{Estatísticas}
\begin{itemize}
    \item Inflação: 20\% em 2024.
    \item Dívida: 60 bilhões USD.
\end{itemize}
...
\begin{itemize}
    \item Pesquisa em diversificação.
    \item Networking com setores emergentes.
\end{itemize}
