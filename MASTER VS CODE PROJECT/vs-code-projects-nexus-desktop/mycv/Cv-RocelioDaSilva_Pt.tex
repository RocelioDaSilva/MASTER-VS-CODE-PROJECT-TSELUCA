...
\begin{minipage}[t]{\dimexpr 0.705\paperwidth - 26pt}
  ...
  petrolífera. Líder da equipa ISPTEC no PetroChamp, Membership Chairperson do SPE
  ...
  \expEntry{Membership Chairperson -- SPE Student Chapter}%
           ...
           {2026 – Presente}
  \begin{itemize}
    \item Lidera recrutamento, engagement e retenção de membros.
    \item Coordena seminários técnicos e promove networking indústria-academia.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Serviu de liaison entre a liderança académica e o corpo estudantil.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Apresentou resultados a stakeholders internacionais e à liderança do ISPTEC.
  ...
  \begin{itemize}
    ...
    \item Módulo de selecção de método EOR: análise multicritério (WAG, polímeros, CO₂ flooding).
  ...
  \begin{tabular}{@{} p{0.06\linewidth} p{0.88\linewidth} @{}}
    ...
    {\bfseries\color{cvgold}2025} &
      \textbf{MIT Global Classroom} -- Solar Comunitário; estudo apresentado a colaboradores internacionais.\\
