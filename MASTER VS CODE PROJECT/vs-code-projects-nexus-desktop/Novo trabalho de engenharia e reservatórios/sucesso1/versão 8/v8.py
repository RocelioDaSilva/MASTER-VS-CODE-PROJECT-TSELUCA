"""
PETRONALYSIS - PLATAFORMA COMPLETA EOR COM JUSTIFICAÇÕES E ANÁLISE DE SUITABILITY
=====================================================================================
...
WINDOW_CONFIG = {
    'title': 'PetroNalysis - Plataforma de Triagem EOR com Justificações e Suitability',
    'geometry': '1400x900',
    'minsize': (1200, 700)
}
...
class EORScreeningEngine:
    ...
    def _load_reservoir_types(self):
        """Carrega características específicas de cada tipo de reservatório baseado em análise de literatura"""
        return {
            "Sem Seleção Específica": {
                "profundidade_tipica": "Variável",
                "profundidade_range": (0, 7000),
                "api_ideal": "Variável",
                "api_range": (0, 60),
                "viscosidade_ideal": "Variável",
                "composicao": "Não especificada",
                "porosidade_range": (5, 50),
                "permeabilidade_range": (0.1, 10000),
                "metodos_prioritarios": ["Todos os 16 métodos com scoring padrão"],
                "metodos_secundarios": ["Análise sem restrições geológicas"],
                "caroterizacao": "Análise genérica aplicada. Use para avaliação ampla de métodos.",
                "desafios": ["Sem informações específicas de composição", "Recomenda-se definir tipo para análise mais precisa"],
                "recuperacao_tipica": "Variável (5-60% conforme método)",
                "custo_relativo": "Variável"
            },
            "Convencional Onshore": {
                "profundidade_tipica": "500-2000m",
                "profundidade_range": (500, 2000),
                "api_ideal": "20-35",
                "api_range": (20, 35),
                "viscosidade_ideal": "leve a médio",
                "composicao": "Arenito com intercalações de argilito. Mineralogia simples.",
                "porosidade_range": (15, 35),
                "permeabilidade_range": (500, 5000),
                "metodos_prioritarios": ["Polímero", "Surfactante", "Alcalino", "CO₂ Miscível"],
                "metodos_secundarios": ["WAG", "Água Inteligente"],
                "metodos_evitar": ["Injeção de Vapor"],
                "caroterizacao": "Múltiplos métodos viáveis. Injeção de água com aditivos eficaz. Estrutura geológica favorável.",
                "desafios": [
                    "Risco de precipitação de polímero em alta salinidade",
                    "Possível adsorção de surfactante em minerais argilosos",
                    "Variabilidade lateral de propriedades",
                    "Heterogeneidade moderada pode afetar varrido"
                ],
                "recuperacao_tipica": "15-45%",
                "custo_relativo": "Moderado"
            },
            "Petróleo Pesado/Viscoso": {
                "profundidade_tipica": "< 2500m",
                "profundidade_range": (100, 2500),
                "api_ideal": "< 20",
                "api_range": (0, 20),
                "viscosidade_ideal": "> 100 cP",
                "composicao": "Arenito ou argilito com petróleo muito viscoso. Possível presença de betume.",
                "porosidade_range": (12, 35),
                "permeabilidade_range": (100, 5000),
                "metodos_prioritarios": ["Injeção de Vapor", "Combustão in-situ"],
                "metodos_secundarios": ["CO₂ Miscível", "WAG pós-vapor"],
                "metodos_evitar": ["Polímero em profundidades altas", "Nitrogênio"],
                "caroterizacao": "Viscosidade muito elevada. Métodos térmicos cruciais para reduzir viscosidade. Recuperação primária mínima.",
                "desafios": [
                    "Extrema dificuldade de mobilização do óleo",
                    "Custos operacionais muito elevados para métodos térmicos",
                    "Geração de calor requer injeção sustentada de vapor/combustão",
                    "Controle de pressão crítico para evitar subpressurização",
                    "Envolvimento ambiental para produção de vapor",
                    "Possível corrosão de equipamentos e tubulação",
                    "Redução de viscosidade pode levar a movimento gravitacional excessivo"
                ],
                "recuperacao_tipica": "50-60% (Vapor) a 10-15% (Combustão)",
                "custo_relativo": "Alto"
            },
            "Profundo/Ultra-profundo": {
                "profundidade_tipica": "> 2500m",
                "profundidade_range": (2500, 7000),
                "api_ideal": "22-45",
                "api_range": (22, 45),
                "viscosidade_ideal": "baixa a moderada",
                "composicao": "Arenito compactado ou calcário. Mineralogia variável. Pressão e temperatura elevadas.",
                "porosidade_range": (10, 30),
                "permeabilidade_range": (50, 1000),
                "pressao_minima": 1500,
                "metodos_prioritarios": ["CO₂ Miscível", "Nitrogênio Miscível", "Hidrocarboneto Miscível"],
                "metodos_secundarios": ["WAG"],
                "metodos_evitar": ["Vapor", "Combustão"],
                "caroterizacao": "Alta pressão e temperatura favorecem miscibilidade. Métodos químicos desafiadores por custo. Porosidade reduzida.",
                "desafios": [
                    "Custo muito elevado de perfuração e desenvolvimento",
                    "Pressão e temperatura extremas exigem equipamentos especializados",
                    "Transporte de fluidos injetados em profundidade crítico",
                    "Recuperação primária/secundária mínima antes de EOR",
                    "Possível perda de pressão após desenvolvimento extenso",
                    "Eficiência de varrido comprometida por capilaridade elevada",
                    "Incerteza geológica aumentada em profundidades extremas"
                ],
                "recuperacao_tipica": "5-15%",
                "custo_relativo": "Muito Alto"
            },
            "Offshore Intermediário": {
                "profundidade_tipica": "1500-3000m",
                "profundidade_range": (1500, 3000),
                "profundidade_agua": "100-1000m",
                "api_ideal": "25-40",
                "api_range": (25, 40),
                "viscosidade_ideal": "leve a médio",
                "composicao": "Arenito com siltito e argilito. Estrutura sedimentar complexa. Influência de correntes marinhas.",
                "porosidade_range": (12, 28),
                "permeabilidade_range": (100, 2000),
                "metodos_prioritarios": ["CO₂ Miscível", "Polímero com modificação"],
                "metodos_secundarios": ["WAG", "Gás Hidrocarbonetos"],
                "metodos_evitar": ["Vapor"],
                "caroterizacao": "Planejamento crítico de espaço. Métodos mistos possíveis. Restrições de topside severas.",
                "desafios": [
                    "Espaço limitado na plataforma para instalações de EOR",
                    "Custos muito elevados de transporte e armazenagem de fluidos",
                    "Problemas ambientais e regulatórios marinhos",
                    "Clima severo pode interromper operações",
                    "Manutenção offshore custosa e complexa",
                    "Perda de pressão ao longo das linhas submarinas",
                    "Segurança ocupacional offshore adicional requerida"
                ],
                "recuperacao_tipica": "10-25%",
                "custo_relativo": "Muito Alto"
            },
            "Carbonatado": {
                "profundidade_tipica": "Variável (500-3500m)",
                "profundidade_range": (500, 3500),
                "api_ideal": "18-35",
                "api_range": (18, 35),
                "composicao": "Calcário ou dolomita com possível anidrita/gesso. Molhabilidade frequentemente hidrofóbica.",
                "molhabilidade": "Frequentemente hidrofóbica (oil-wet)",
                "porosidade_range": (5, 20),
                "permeabilidade_controlada_por": "Fraturas naturais e estilólitos",
                "heterogeineidade": "Muito elevada",
                "metodos_prioritarios": ["CO₂ Miscível", "Gás Hidrocarbonetos", "WAG"],
                "metodos_secundarios": ["Polímero - efetividade reduzida"],
                "metodos_evitar": ["Alcalino - consumo excessivo", "Surfactante"],
                "caroterizacao": "Presença de anidrita/gesso consome alcalino. Molhabilidade hidrofóbica reduz eficiência de água. Gás miscível preferível.",
                "desafios": [
                    "Molhabilidade hidrofóbica reduz imbibição de água",
                    "Anidrita/gesso consome (reage com) alcalino e CO₂",
                    "Fraturas naturais podem causar vazamento prematuro de injetados",
                    "Permeabilidade dependente de tensão efetiva - mudanças de pressão afetam fluxo",
                    "Heterogeneidade extrema dificulta previsão de desempenho",
                    "Possível geração de finos (calcita precipitada) bloqueando poros",
                    "pH sensível em calcário - controle crítico necessário",
                    "Eficiência de varrido comprometida por contraste de mobilidade"
                ],
                "recuperacao_tipica": "5-20%",
                "custo_relativo": "Muito Alto"
            },
            "Teor Argila Elevado": {
                "profundidade_tipica": "Variável",
                "profundidade_range": (0, 5000),
                "api_ideal": "20-35",
                "api_range": (20, 35),
                "composicao": "Areia com >10% argila (ilita, caolinita, montmorillonita misturadas com quartzo).",
                "teor_argila": "> 10% (misturada com areia)",
                "tipos_argila": "Ilita, caolinita, montmorillonita",
                "adsorção": "Muito elevada para surfactantes e alguns polímeros",
                "porosidade_range": (10, 30),
                "permeabilidade_range": (50, 1000),
                "metodos_prioritarios": ["CO₂ Miscível", "Injeção de Vapor se aplicável"],
                "metodos_secundarios": ["WAG", "Polímero com dose elevada"],
                "metodos_evitar": ["Polímero (perda 30-50%)", "Surfactante", "Alcalino em altas concentrações"],
                "caroterizacao": "Alta adsorção reduz eficiência de químicos. Gás menos afetado. Inchamento de argila possível.",
                "desafios": [
                    "Adsorção elevada de surfactante reduz eficiência de deslocamento microscópico",
                    "Adsorção de polímero reduz concentração efetiva (perda 30-50%)",
                    "Potencial de inchamento/shrinkage de argila afeta permeabilidade",
                    "Movimento de finos (migração de argila) pode bloquear poros",
                    "Concentração iônica crítica - água de baixa salinidade pode inchar argila",
                    "Hidrólise de polímeros acelerada por argila",
                    "Bloqueio de poros por precipitação de fines (causado por mudança de pH/salinidade)",
                    "Redução permanente de permeabilidade possível"
                ],
                "recuperacao_tipica": "5-20%",
    ...
    def _load_criteria(self):
        """Carrega critérios de triagem baseados em dados estatísticos de projetos reais"""
        return {
            # =====================================================================
            # INJEÇÃO DE GÁS MISCÍVEL - Baseado em 153-338 projetos internacionais
            # =====================================================================
            "CO₂ Miscível": {
                "API": {"min": 22, "max": 45, "peso": 0.25, "media": 37},
                "Viscosidade": {"min": 0.0, "max": 35, "peso": 0.2, "media": 2.0},
                "Porosidade": {"min": 37, "max": 83, "peso": 0.15, "media": 15},
                "Saturação de Óleo": {"min": 89, "max": 1515, "peso": 0.15, "media": 46},
                "Permeabilidade": {"min": 1.5, "max": 4500, "peso": 0.15, "media": 209},
                "Profundidade": {"min": 1500, "max": 13365, "peso": 0.1, "media": 6230}
            },
            "Injeção de Vapor": {
                "API": {"min": 14, "max": 48, "peso": 0.3, "media": 14.6},
                "Viscosidade": {"min": 3, "max": 1516, "peso": 0.3, "media": 32594},
                "Porosidade": {"min": 12, "max": 65, "peso": 0.15, "media": 32.2},
                "Saturação de Óleo": {"min": 20, "max": None, "peso": 0.15, "media": 50},
                "Permeabilidade": {"min": 1, "max": 15001, "peso": 0.1, "media": 2669}
            },
            "WAG (Water-Alternating-Gas)": {
                "API": {"min": 3, "max": 39, "peso": 0.2, "media": 35},
                "Viscosidade": {"min": 0.9, "max": 60.3, "peso": 0.2, "media": 0.6},
                "Porosidade": {"min": 14.5, "max": 124, "peso": 0.15, "media": 18.3},
                "Profundidade": {"min": 750, "max": 41000, "peso": 0.2, "media": 7545},
                "Pressão": {"min": 1000, "max": None, "peso": 0.15, "media": 1500},
                "Permeabilidade": {"min": 50, "max": 2000, "peso": 0.1, "media": 500}
            },
            "Nitrogênio Miscível": {
                "API": {"min": 35, "max": 54, "peso": 0.25, "media": 47},
                "Viscosidade": {"min": 0.0, "max": 0.2, "peso": 0.2, "media": 0.07},
                "Porosidade": {"min": 7.5, "max": 14, "peso": 0.15, "media": 11.2},
                "Profundidade": {"min": 1000, "max": 18500, "peso": 0.2, "media": 14633},
                "Pressão": {"min": 1500, "max": None, "peso": 0.15, "media": 2000},
                "Permeabilidade": {"min": 0.2, "max": 35, "peso": 0.1, "media": 15.0}
            },
            "Hidrocarboneto Miscível": {
                "API": {"min": 22, "max": 57, "peso": 0.25, "media": 38},
                "Viscosidade": {"min": 0.04, "max": 318000, "peso": 0.25, "media": 286},
                "Porosidade": {"min": 10, "max": 45, "peso": 0.15, "media": 14},
                "Profundidade": {"min": 4040, "max": 15900, "peso": 0.2, "media": 8343},
                "Saturação de Óleo": {"min": 30, "max": None, "peso": 0.15, "media": 45}
            },
            
            # =====================================================================
            # INJEÇÃO DE GÁS IMISCÍVEL - Baseado em 8-16 projetos
            # =====================================================================
            "Nitrogênio Imiscível": {
                "API": {"min": 16, "max": 54, "peso": 0.25, "media": 34},
                "Viscosidade": {"min": 0, "max": 618000, "peso": 0.2, "media": 2256},
                "Porosidade": {"min": 11, "max": 28, "peso": 0.15, "media": 19},
                "Profundidade": {"min": 1700, "max": 18500, "peso": 0.2, "media": 7914},
                "Permeabilidade": {"min": 3, "max": 2800, "peso": 0.15, "media": 1041},
                "Dip": {"min": 10, "max": None, "peso": 0.05, "media": 20}
            },
            "CO₂ Imiscível": {
                "API": {"min": 11, "max": 35, "peso": 0.25, "media": 22},
                "Viscosidade": {"min": 0.6, "max": 6592, "peso": 0.2, "media": 65},
                "Porosidade": {"min": 17, "max": 32, "peso": 0.15, "media": 26.3},
                "Profundidade": {"min": 1150, "max": 8500, "peso": 0.2, "media": 3385},
                "Permeabilidade": {"min": 36, "max": 1000, "peso": 0.15, "media": 217},
                "Saturação de Óleo": {"min": 25, "max": None, "peso": 0.05, "media": 45}
            },
            "Hidrocarboneto Imiscível": {
                "API": {"min": 22, "max": 48, "peso": 0.3, "media": 35},
                "Viscosidade": {"min": 0.25, "max": 4, "peso": 0.2, "media": 2},
                "Porosidade": {"min": 5, "max": 22, "peso": 0.15, "media": 13},
                "Profundidade": {"min": 600, "max": 7000, "peso": 0.2, "media": 6500},
                "Saturação de Óleo": {"min": 75, "max": 83, "peso": 0.15, "media": 79}
            },
            
            # =====================================================================
            # MÉTODOS QUÍMICOS - Baseado em 4-53 projetos
            # =====================================================================
            "Injeção de Polímeros": {
                "API": {"min": 13, "max": 42.5, "peso": 0.2, "media": 26.5},
                "Viscosidade": {"min": 0.4, "max": 4000, "peso": 0.25, "media": 123.2},
                "Porosidade": {"min": 10.4, "max": 33, "peso": 0.15, "media": 24.2},
                "Salinidade": {"min": 0, "max": 20000, "peso": 0.2, "media": 10000},
                "Temperatura": {"min": 20, "max": 90, "peso": 0.15, "media": 60},
                "Permeabilidade": {"min": 1.8, "max": 5500, "peso": 0.1, "media": 223}
            },
            "Injeção de Surfactantes": {
                "API": {"min": 22, "max": 39, "peso": 0.2, "media": 31},
                "Viscosidade": {"min": 2.63, "max": 7.5, "peso": 0.2, "media": 7.08},
                "Porosidade": {"min": 14, "max": 16.8, "peso": 0.15, "media": 15.4},
                "Salinidade": {"min": 0, "max": 10000, "peso": 0.2, "media": 5000},
                "Saturação de Óleo": {"min": 43.5, "max": 53, "peso": 0.15, "media": 49},
                "Permeabilidade": {"min": 50, "max": 1520, "peso": 0.1, "media": 400}
            },
            "Injeção Alcalina (ASP)": {
                "API": {"min": 23, "max": 34, "peso": 0.2, "media": 32},
                "Viscosidade": {"min": 11, "max": 6500, "peso": 0.2, "media": 875},
                "Porosidade": {"min": 26, "max": 32, "peso": 0.15, "media": 26.6},
                "Salinidade": {"min": 0, "max": 5000, "peso": 0.2, "media": 3000},
                "Temperatura": {"min": 20, "max": 80, "peso": 0.15, "media": 60},
                "Permeabilidade": {"min": 596, "max": 1520, "peso": 0.1, "media": 1000}
            },
            "Polímero-Surfactante": {
                "API": {"min": 22, "max": 39, "peso": 0.2, "media": 31},
                "Viscosidade": {"min": 2.63, "max": 7.5, "peso": 0.2, "media": 7.08},
                "Porosidade": {"min": 14, "max": 16.8, "peso": 0.15, "media": 15.4},
                "Salinidade": {"min": 0, "max": 15000, "peso": 0.2, "media": 8000},
                "Temperatura": {"min": 20, "max": 85, "peso": 0.15, "media": 60},
                "Permeabilidade": {"min": 30, "max": 2000, "peso": 0.1, "media": 500}
            },
            "Injeção de Água Inteligente": {
                "API": {"min": 20, "max": 40, "peso": 0.2, "media": 30},
                "Viscosidade": {"min": 0.5, "max": 200, "peso": 0.2, "media": 50},
                "Porosidade": {"min": 15, "max": 35, "peso": 0.15, "media": 25},
                "Salinidade": {"min": 5000, "max": 100000, "peso": 0.2, "media": 50000},
                "Temperatura": {"min": 20, "max": 120, "peso": 0.15, "media": 70},
                "Permeabilidade": {"min": 50, "max": 2000, "peso": 0.1, "media": 500}
            },
            
            # =====================================================================
            # MÉTODOS TÉRMICOS - Baseado em 2-27 projetos
            # =====================================================================
            "Combustão In Situ": {
                "API": {"min": 23.6, "max": 38, "peso": 0.3, "media": 27},
                "Viscosidade": {"min": 1.44, "max": 5000, "peso": 0.25, "media": 504.8},
                "Porosidade": {"min": 14, "max": 35, "peso": 0.15, "media": 23.3},
                "Profundidade": {"min": 400, "max": 11300, "peso": 0.15, "media": 5569},
                "Permeabilidade": {"min": 10, "max": 15000, "peso": 0.15, "media": 231.5}
            },
            "Injeção Cíclica de Vapor (CSS)": {
                "API": {"min": 14, "max": 25, "peso": 0.3, "media": 18},
                "Viscosidade": {"min": 100, "max": 5000, "peso": 0.3, "media": 1000},
                "Porosidade": {"min": 15, "max": 40, "peso": 0.15, "media": 28},
                "Profundidade": {"min": 150, "max": 2000, "peso": 0.15, "media": 800},
                "Espessura": {"min": 5, "max": None, "peso": 0.1, "media": 20}
            },
            "VAPEX (Vapor Extraction)": {
                "API": {"min": 10, "max": 20, "peso": 0.3, "media": 14},
                "Viscosidade": {"min": 1000, "max": 10000, "peso": 0.3, "media": 3000},
                "Porosidade": {"min": 20, "max": 40, "peso": 0.15, "media": 30},
                "Profundidade": {"min": 500, "max": 2000, "peso": 0.15, "media": 1000},
                "Espessura": {"min": 10, "max": None, "peso": 0.1, "media": 25}
            },
    ...
    def _get_method_penalty_for_type(self, method: str, reservoir_type: str) -> float:
        """Retorna multiplicador de penalidade baseado no tipo de reservatório.
        
        Valores > 1.0 aumentam a penalidade (reduzem o score).
        Valores < 1.0 aumentam o score (método é mais adequado).
        """
        penalties = {
            "Convencional Onshore": {
                "Injeção de Vapor": 1.2,
                "Combustão in-situ": 1.3,
                "CO₂ Miscível": 0.9,
                "Polímero": 0.8,
                "Surfactante": 0.85,
                "Alcalino": 0.85,
            ...
            "Petróleo Pesado/Viscoso": {
                "Injeção de Vapor": 0.6,
                "Combustão in-situ": 0.7,
                "CO₂ Miscível": 0.9,
                "Polímero": 1.5,
                "Surfactante": 1.4,
                "Alcalino": 1.3,
                "Nitrogênio Miscível": 1.1,
            },
            "Profundo/Ultra-profundo": {
                "Injeção de Vapor": 2.0,
                "Combustão in-situ": 2.0,
                "CO₂ Miscível": 0.7,
                "Nitrogênio Miscível": 0.8,
                "Hidrocarboneto Miscível": 0.75,
                "Polímero": 1.5,
                "Surfactante": 1.6,
            },
            "Offshore Intermediário": {
                "Injeção de Vapor": 1.8,
                "CO₂ Miscível": 0.8,
                "WAG": 0.85,
                "Polímero": 0.9,
                "Nitrogênio Miscível": 0.9,
            },
            "Carbonatado": {
                "Alcalino": 2.0,
                "Surfactante": 1.8,
                "CO₂ Miscível": 0.7,
                "Gás Hidrocarbonetos": 0.75,
                "Polímero": 1.3,
            },
            "Teor Argila Elevado": {
                "Polímero": 1.5,
                ...
                "Alcalino": 1.3,
                "CO₂ Miscível": 0.8,
                "Injeção de Vapor": 0.9,
                "Nitrogênio": 0.85,
            }
        }
        
        type_penalties = penalties.get(reservoir_type, {})
        return type_penalties.get(method, 1.0)
    ...
    def score_reservoir(self, reservoir_data: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
        ...
        # Obter tipo de reservatório se disponível
        ...
        for method, criteria in self.criteria.items():
            try:
                score = self._calculate_method_score(method, criteria, reservoir_data, reservoir_type, type_data)
                scores[method] = score
                logger.info(f"Score calculado para {method}: {score['score']:.1f}% (Tipo: {reservoir_type})")
            except Exception as e:
    ...
    def _calculate_method_score(self, method: str, criteria: Dict, 
                               reservoir_data: Dict, reservoir_type: str = "Convencional", 
                               type_data: Dict = None) -> Dict[str, Any]:
        ...
        Args:
            ...
            reservoir_data: Dados do reservatório
            reservoir_type: Tipo de reservatório (para ajustar critérios)
            type_data: Dados específicos do tipo de reservatório
        ...
        # Ajustar peso de critérios baseado no tipo de reservatório
        ...
        # Aplicar penalidade/boost baseado no tipo de reservatório
        ...
        # Adicionar info do tipo de reservatório à justificativa se penalidade foi aplicada
        type_note = ""
        if penalty_multiplier < 0.95:
            type_note = f"\n✅ NOTA: Este método é particularmente adequado para reservatórios {reservoir_type}."
        elif penalty_multiplier > 1.05:
            type_note = f"\n⚠️ NOTA: Este método é menos adequado para reservatórios {reservoir_type}."
        
        # Determinar status baseado em thresholds
        if normalized_score >= SUITABILITY_THRESHOLDS['alta']:
            status = "RECOMENDADO"
            color = "green"
            justificativa = self.justifications.get(method, {}).get("alta", "") + type_note
        elif normalized_score >= SUITABILITY_THRESHOLDS['media']:
            status = "POTENCIAL"
            color = "orange"
            justificativa = self.justifications.get(method, {}).get("media", "") + type_note
        else:
            status = "NÃO RECOMENDADO"
            color = "red"
            justificativa = self.justifications.get(method, {}).get("baixa", "") + type_note
    ...
    def generate_justification_report(self, reservoir_data: Dict[str, Any], 
        ...
        report = []
        report.append("=" * 100)
        report.append("RELATÓRIO DE JUSTIFICAÇÕES E SUITABILITY - PETRONALYSIS")
        report.append("=" * 100)
...
# ============================================================================
# PLATAFORMA PRINCIPAL - PETRONALYSIS
# ============================================================================
class PetroNalysisPlatform:
    """Plataforma principal PetroNalysis com análise avançada de EOR.
    ...
    def __init__(self):
        """Inicializa plataforma PetroNalysis com todos os componentes."""
        try:
            ...
            logger.info("PetroNalysis inicializado com sucesso")
            
        except Exception as e:
            logger.error(f"Erro ao inicializar PetroNalysisPlatform: {str(e)}")
            raise
    ...
    def _create_main_interface(self):
        ...
        self.status_bar = tk.Label(self.root, text="Pronto | PetroNalysis v7.4 COMPLETO (Fases 1B + 2 + 3)", 
    ...
    def _create_dashboard_tab(self):
        ...
        tk.Label(title_frame, text="PetroNalysis - Plataforma de Triagem EOR", 
    ...
    def _create_data_tab(self):
        """Cria aba para entrada de dados com seletor de tipo de reservatório expandido"""
        ...
        # ===== SELEÇÃO DE TIPO DE RESERVATÓRIO (EXPANDIDA) =====
        ttk.Label(left_panel, text="🏔️ TIPO DE RESERVATÓRIO", 
                 font=('Arial', 11, 'bold')).pack(pady=(10, 5))
        
        ttk.Label(left_panel, text="Selecione o tipo geológico para scoring otimizado:", 
                 font=('Arial', 9), justify='left').pack(pady=(0, 10))
        
        self.reservoir_type_var = tk.StringVar(value="Sem Seleção Específica")
        ...
        self.reservoir_type_combo = ttk.Combobox(
            type_frame, 
            textvariable=self.reservoir_type_var,
            values=reservoir_types,
            state='readonly',
            width=35
        )
        self.reservoir_type_combo.pack(fill='x', pady=(0, 10))
        self.reservoir_type_combo.bind('<<ComboboxSelected>>', self._on_reservoir_type_changed)
        
        # Info box para o tipo selecionado - COM SCROLLBAR
        info_label = ttk.Label(left_panel, text="Características do Tipo Selecionado:", 
                              font=('Arial', 9, 'bold'))
        info_label.pack(pady=(5, 5))
        
        # Frame com scrollbar para as informações
        info_frame = ttk.Frame(left_panel, height=250)
        info_frame.pack(fill='both', expand=True, pady=(0, 10))
        
        # Canvas com scrollbar vertical e horizontal
        info_canvas = tk.Canvas(info_frame, bg='white', highlightthickness=1, highlightbackground='#bdc3c7')
        info_scrollbar_v = ttk.Scrollbar(info_frame, orient=tk.VERTICAL, command=info_canvas.yview)
        info_scrollbar_h = ttk.Scrollbar(info_frame, orient=tk.HORIZONTAL, command=info_canvas.xview)
        
        info_canvas.configure(yscrollcommand=info_scrollbar_v.set, xscrollcommand=info_scrollbar_h.set)
        
        self.reservoir_info_text = tk.Text(info_canvas, wrap='word', font=('Courier New', 9), 
                                           height=15, width=45, bg='#f8f9fa', relief='flat')
        
        info_canvas.create_window(0, 0, window=self.reservoir_info_text, anchor='nw')
        
        def _on_text_configure(event):
            info_canvas.configure(scrollregion=info_canvas.bbox('all'))
        
        self.reservoir_info_text.bind('<Configure>', _on_text_configure)
        
        info_canvas.pack(side=tk.LEFT, fill='both', expand=True)
        info_scrollbar_v.pack(side=tk.RIGHT, fill='y')
        info_scrollbar_h.pack(side=tk.BOTTOM, fill='x')
        
        # Trigger inicial para mostrar informações do tipo padrão
        self._on_reservoir_type_changed()
        
        ttk.Separator(left_panel, orient=tk.HORIZONTAL).pack(fill='x', pady=10)
        ...
        # Frame com scrollbar para o formulário manual
        ...
        for i, (param, unit) in enumerate(parameters):
            ...
            tk.Label(row, text=unit, width=12).pack(side=tk.LEFT)
            
            self.manual_entries[param] = entry
        
        form_canvas.pack(side=tk.LEFT, fill='both', expand=True)
        form_scrollbar.pack(side=tk.RIGHT, fill='y')
        ...
        # Criar um canvas com scrollbars para a tabela
        table_container = ttk.Frame(right_panel)
        table_container.pack(fill='both', expand=True)
        
        table_canvas = tk.Canvas(table_container, bg='white', highlightthickness=0)
        table_scrollbar_v = ttk.Scrollbar(table_container, orient=tk.VERTICAL, command=table_canvas.yview)
        table_scrollbar_h = ttk.Scrollbar(table_container, orient=tk.HORIZONTAL, command=table_canvas.xview)
        
        table_canvas.configure(yscrollcommand=table_scrollbar_v.set, xscrollcommand=table_scrollbar_h.set)
        
        columns = ("ID", "API", "Viscosidade", "Profundidade", "Tipo", "Status")
        self.data_tree = ttk.Treeview(table_canvas, columns=columns, show='headings', height=20)
        ...
        for col in columns:
            ...
            if col == "ID":
                ...
                self.data_tree.column(col, width=110)
        
        table_canvas.create_window((0, 0), window=self.data_tree, anchor="nw")
        
        def _on_tree_configure(event):
            table_canvas.configure(scrollregion=table_canvas.bbox('all'))
        
        self.data_tree.bind('<Configure>', _on_tree_configure)
        
        table_canvas.pack(side=tk.LEFT, fill='both', expand=True)
        table_scrollbar_v.pack(side=tk.RIGHT, fill='y')
        table_scrollbar_h.pack(side=tk.BOTTOM, fill='x')
        
        # Botões de ação
        btn_frame = ttk.Frame(right_panel)
        btn_frame.pack(fill='x', pady=(10, 0))
        
        ttk.Button(btn_frame, text="👁️ Ver Detalhes", 
    ...
    def show_suitability_dashboard(self):
        """Mostra dashboard completo de suitability com scrollbars para navegação completa"""
        if not hasattr(self, 'screening_results') or not self.screening_results:
            messagebox.showwarning("Aviso", "Execute a triagem primeiro")
            return
        ...
        dashboard_window.title("Dashboard de Suitability - PetroNalysis")
        dashboard_window.geometry("1400x900")
        
        # Criar main frame com canvas e scrollbar (para scrolling vertical principal)
        main_canvas = tk.Canvas(dashboard_window, bg='white', highlightthickness=0)
        main_scrollbar = ttk.Scrollbar(dashboard_window, orient=tk.VERTICAL, command=main_canvas.yview)
        ...
        summary_text = f"""
    ESTATÍSTICAS GERAIS:
    ├─ Total de Métodos Analisados: {len(methods)}
    ├─ Métodos Recomendados (≥80%):  {alta_count} ({alta_count/len(methods)*100:.1f}%)
    ├─ Métodos Potenciais (60-79%):  {media_count} ({media_count/len(methods)*100:.1f}%)
    ├─ Métodos Não Recomendados (<60%): {baixa_count} ({baixa_count/len(methods)*100:.1f}%)
    ├─ Score Médio: {media_score:.1f}%
    ├─ Score Máximo: {max(scores):.1f}% ({methods[np.argmax(scores)]})
    └─ Score Mínimo: {min(scores):.1f}% ({methods[np.argmin(scores)]})
        """
        
        ttk.Label(summary_frame, text=summary_text, justify='left', font=('Courier', 10)).pack(anchor='w')
        
        # ========== SEÇÃO 2: GRÁFICOS (Com scroll horizontal para muitos métodos) ==========
        charts_frame = ttk.LabelFrame(scrollable_frame, text="📈 VISUALIZAÇÕES GRÁFICAS", padding=10)
        charts_frame.pack(fill='both', expand=True, padx=10, pady=10)
        
        # Notebook para diferentes tipos de visualizações
        charts_notebook = ttk.Notebook(charts_frame)
        charts_notebook.pack(fill='both', expand=True)
        
        # TAB 1: Visão Geral (2x2)
        overview_tab = ttk.Frame(charts_notebook)
        charts_notebook.add(overview_tab, text="Visão Geral")
        
        fig_overview, axes = plt.subplots(2, 2, figsize=(13, 10))
        fig_overview.suptitle('Dashboard de Suitability - Visão Geral Completa', fontsize=14, fontweight='bold')
        
        # 1. Gráfico de barras com scroll
        colors = ['#27ae60' if s >= 80 else '#f39c12' if s >= 60 else '#e74c3c' for s in scores]
        axes[0, 0].barh(methods, scores, color=colors, edgecolor='black', linewidth=1)
        axes[0, 0].set_xlabel('Pontuação de Suitability (%)', fontweight='bold')
        axes[0, 0].set_title('Ranking Completo de Métodos')
        axes[0, 0].set_xlim(0, 105)
        axes[0, 0].grid(True, alpha=0.3, axis='x')
        
        # 2. Distribuição por categoria (Pie)
        categories = {'Alta (≥80%)': alta_count, 'Média (60-79%)': media_count, 'Baixa (<60%)': baixa_count}
        ...
        axes[0, 1].set_title('Distribuição de Suitability')
        
        # 3. Top 10 métodos
        top_count = min(10, len(methods))
        top_methods = sorted(self.screening_results.items(), 
                            key=lambda x: x[1]['score'], reverse=True)[:top_count]
        top_names = [m[0][:20] + '...' if len(m[0]) > 20 else m[0] for m in top_methods]
        top_scores = [m[1]['score'] for m in top_methods]
        
        axes[1, 0].bar(range(top_count), top_scores, 
                      color=['#27ae60' if s >= 80 else '#f39c12' if s >= 60 else '#e74c3c' for s in top_scores],
                      edgecolor='black', linewidth=1.5)
        axes[1, 0].set_xticks(range(top_count))
        axes[1, 0].set_xticklabels(top_names, rotation=45, ha='right')
        axes[1, 0].set_ylabel('Pontuação (%)', fontweight='bold')
        axes[1, 0].set_title(f'Top {top_count} Métodos')
        axes[1, 0].set_ylim(0, 105)
        
        for i, (bar, score) in enumerate(zip(axes[1, 0].patches, top_scores)):
            axes[1, 0].text(bar.get_x() + bar.get_width()/2, score + 2, f'{score:.1f}%',
                           ha='center', va='bottom', fontweight='bold', fontsize=9)
        
        # 4. Heatmap de parâmetros
        ...
        im = axes[1, 1].imshow(heatmap_data, aspect='auto', cmap='RdYlGn', vmin=0, vmax=100, interpolation='nearest')
        axes[1, 1].set_yticks(range(len(param_names)))
        axes[1, 1].set_yticklabels(param_names, fontweight='bold')
        axes[1, 1].set_xticks(range(min(8, len(methods))))  # Limitar a 8 para legibilidade
        axes[1, 1].set_xticklabels([m[:12] for m in methods[:8]], rotation=45, ha='right', fontsize=8)
        axes[1, 1].set_title('Heatmap de Parâmetros (primeiros 8 métodos)')
        ...
        canvas_overview = FigureCanvasTkAgg(fig_overview, overview_tab)
        canvas_overview.draw()
        canvas_overview.get_tk_widget().pack(fill='both', expand=True)
        
        # TAB 2: Análise Detalhada (Treeview com scroll)
        detail_tab = ttk.Frame(charts_notebook)
        charts_notebook.add(detail_tab, text="Análise Detalhada")
        
        # Canvas com scrollbar para treeview
        detail_canvas = tk.Canvas(detail_tab, highlightthickness=0)
        detail_scrollbar_v = ttk.Scrollbar(detail_tab, orient=tk.VERTICAL, command=detail_canvas.yview)
        detail_scrollbar_h = ttk.Scrollbar(detail_tab, orient=tk.HORIZONTAL, command=detail_canvas.xview)
        ...
        detail_canvas.configure(yscrollcommand=detail_scrollbar_v.set, xscrollcommand=detail_scrollbar_h.set)
        
        columns = ("Método", "Suitability %", "Status", "Fortes", "Fracos", "Recomendação")
        detail_tree = ttk.Treeview(detail_scrollable_frame, columns=columns, show='headings', height=25)
        
        detail_tree.heading("Método", text="Método EOR")
        detail_tree.heading("Suitability %", text="Score")
        detail_tree.heading("Status", text="Status")
        detail_tree.heading("Fortes", text="Pontos\nFortes")
        detail_tree.heading("Fracos", text="Pontos\nFragos")
        detail_tree.heading("Recomendação", text="Recomendação")
        
        detail_tree.column("Método", width=180)
        detail_tree.column("Suitability %", width=80)
        detail_tree.column("Status", width=100)
        detail_tree.column("Fortes", width=80)
        detail_tree.column("Fracos", width=80)
        detail_tree.column("Recomendação", width=150)
        
        # Preencher com dados
        for method, data in self.screening_results.items():
            pontos_fortes = len(data.get('pontos_positivos', []))
            pontos_fracos = len(data.get('pontos_negativos', []))
            
            tag = 'alta' if data['score'] >= 80 else 'media' if data['score'] >= 60 else 'baixa'
            recomendacao = "✓ RECOMENDADO" if tag == 'alta' else "~ POTENCIAL" if tag == 'media' else "✗ NÃO RECOMENDADO"
        ...
        detail_tree.tag_configure('alta', background='#d5f4e6', foreground='#0e6251')
        detail_tree.tag_configure('media', background='#fdebd0', foreground='#7d6608')
        detail_tree.tag_configure('baixa', background='#fadbd8', foreground='#7b241c')
        
        detail_tree.pack(fill='both', expand=True, padx=0, pady=0)
        
        detail_canvas.pack(side=tk.LEFT, fill='both', expand=True)
        detail_scrollbar_v.pack(side=tk.RIGHT, fill='y')
        detail_scrollbar_h.pack(side=tk.BOTTOM, fill='x')
        
        # TAB 3: Comparativo de Métodos
        comparison_tab = ttk.Frame(charts_notebook)
        charts_notebook.add(comparison_tab, text="Comparativo Radar")
        
        fig_radar = self._create_comparison_radar(methods[:8])  # Limitar a 8 para legibilidade
        canvas_radar = FigureCanvasTkAgg(fig_radar, comparison_tab)
        canvas_radar.draw()
        ...
        export_btn = ttk.Button(action_frame, text="💾 Exportar Dashboard", 
                               command=lambda: self.export_suitability_dashboard(fig_overview))
        export_btn.pack(side=tk.LEFT, padx=5)
        
        close_btn = ttk.Button(action_frame, text="❌ Fechar", command=dashboard_window.destroy)
        close_btn.pack(side=tk.LEFT, padx=5)
        
        print("Dashboard com scrollbars criado com sucesso!")
        self.update_status("Dashboard de Suitability aberto com sucesso")
    ...
    def import_csv(self):
        ...
        try:
            ...
            # Adicionar tipo de reservatório padrão se não existir
    ...
    def add_manual_reservoir(self):
        ...
        try:
            ...
            # Adicionar tipo de reservatório selecionado
            ...
            messagebox.showinfo("Sucesso", f"Reservatório adicionado como '{reservoir['Tipo_Reservatorio']}'!")
    ...
    def _on_reservoir_type_changed(self, event=None):
        """Atualiza informações quando tipo de reservatório é selecionado"""
        reservoir_type = self.reservoir_type_var.get()
        
        # Obter dados do tipo de reservatório
        type_data = self.screening_engine.reservoir_types_data.get(reservoir_type, {})
        
        # Atualizar caixa de informações com scroll
        self.reservoir_info_text.config(state='normal')
        self.reservoir_info_text.delete('1.0', tk.END)
        
        if type_data:
            info_text = f"""╔══════════════════════════════════════════════════════════════════════╗
║  TIPO DE RESERVATÓRIO: {reservoir_type:<45}║
╚══════════════════════════════════════════════════════════════════════╝

━━━ CARACTERÍSTICAS GEOLÓGICAS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Profundidade:        {type_data.get('profundidade_tipica', 'N/A')}
API Ideal:           {type_data.get('api_ideal', 'N/A')}
Viscosidade:         {type_data.get('viscosidade_ideal', 'N/A')}
Composição:          {type_data.get('composicao', 'Não especificada')}
Porosidade:          {str(type_data.get('porosidade_range', 'N/A')).replace('(', '').replace(')', '')}%
Permeabilidade:      {str(type_data.get('permeabilidade_range', 'N/A')).replace('(', '').replace(')', '')} mD

━━━ MÉTODOS EOR RECOMENDADOS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✓ Prioritários:      {', '.join(type_data.get('metodos_prioritarios', []))}
○ Secundários:       {', '.join(type_data.get('metodos_secundarios', []))}
✗ A Evitar:          {', '.join(type_data.get('metodos_evitar', []))}

━━━ ANÁLISE E CARACTERIZAÇÃO ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{type_data.get('caroterizacao', 'Sem informações')}

Recuperação Esperada: {type_data.get('recuperacao_tipica', 'N/A')}
Custo Relativo:      {type_data.get('custo_relativo', 'N/A')}

━━━ DESAFIOS TÉCNICOS E RISCOS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
            desafios = type_data.get('desafios', [])
            if desafios:
                for i, desafio in enumerate(desafios, 1):
                    info_text += f"  {i}. {desafio}\n"
            else:
                info_text += "  Sem desafios específicos documentados\n"
            
            info_text += "\n" + "━" * 73
            self.reservoir_info_text.insert('1.0', info_text)
        
        self.reservoir_info_text.config(state='disabled')
    ...
    def save_project(self):
        ...
        try:
            project_data = {
                ...
                "version": "PetroNalysis 4.0 com Suitability"
            }
    ...
    def show_documentation(self):
        ...
        docs = """
        PETRONALYSIS - PLATAFORMA DE TRIAGEM EOR COM SUITABILITY
        ...
        doc_window.title("Documentação - PetroNalysis com Suitability")
    ...
    def show_about(self):
        ...
        about_window.title("Sobre o PetroNalysis com Suitability")
    ...
    def copy_to_clipboard(self):
        ...
        text = "RESULTADOS DA TRIAGEM EOR - PETRONALYSIS COM SUITABILITY\n"
        text += "=" * 60 + "\n\n"
...
def main():
    ...
    try:
        ...
        print("=" * 60)
        print("INICIANDO PETRONALYSIS - PLATAFORMA DE TRIAGEM EOR COM SUITABILITY")
        print("Versão: 4.0 (Com Gráficos de Suitability)")
        print(f"Data: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        print("=" * 60)
        
        # Iniciar aplicação
        app = PetroNalysisPlatform()
        app.run()
        ...
        # Salvar log de erro
        try:
            with open('petronalysis_suitability_error.log', 'w') as f:
                f.write(error_msg)
            print("\nLog de erro salvo em: petronalysis_suitability_error.log")
        except:
            pass
