...
% ══════════════════════════════════════════════════════════════════
%  LANDSCAPE VARIANTS
%  Switch the active landscape by changing \ActiveLandscape below.
%  Options: Mountains | City | Dungeon | Wasteland | Forest | Coast
%
%  Each command draws into the overlay tikzpicture already set up
%  by \HeaderStrip (TL/TR coordinates + \SH macro are available).
% ══════════════════════════════════════════════════════════════════

% ── Active landscape selector ──
%   Change this one line to switch the header scene globally.
...
\newcommand{\LandscapeBodyDungeon}{%
  ...
  \fill[Stone!08]
    ($(TL)!.35!(TR)-(0,\SH cm*.30)$)
    ..controls($(TL)!.40!(TR)-(0,\SH cm*.02)$)
           and($(TL)!.60!(TR)-(0,\SH cm*.02)$)..
    ($(TL)!.65!(TR)-(0,\SH cm*.30)$)
...
\newcommand{\LandscapeBodyWasteland}{%
  ...
  \draw[Stone!38,line width=0.4pt]
    ($(TL)!.20!(TR)-(0,\SH cm)$)--($(TL)!.35!(TR)-(0,\SH cm*.78)$)
    --($(TL)!.50!(TR)-(0,\SH cm)$);
  \draw[Stone!38,line width=0.3pt]
    ($(TL)!.35!(TR)-(0,\SH cm*.78)$)--($(TL)!.45!(TR)-(0,\SH cm*.88)$);
  \draw[Stone!38,line width=0.4pt]
    ($(TL)!.55!(TR)-(0,\SH cm)$)--($(TL)!.66!(TR)-(0,\SH cm*.82)$)
    --($(TL)!.80!(TR)-(0,\SH cm)$);
  \draw[Stone!38,line width=0.3pt]
...
\newcommand{\LandscapeBodyForest}{%
  ...
  \fill[Stone!22]
    ($(TL)-(0,\SH cm*.25)$)
    ..controls($(TL)!.08!(TR)-(0,\SH cm*.08)$)
           and($(TL)!.16!(TR)-(0,\SH cm*.30)$)..
    ($(TL)!.22!(TR)-(0,\SH cm*.15)$)
    ..controls($(TL)!.30!(TR)+(0,.10cm)$)
           and($(TL)!.38!(TR)-(0,\SH cm*.28)$)..
    ($(TL)!.45!(TR)-(0,\SH cm*.12)$)
    ..controls($(TL)!.52!(TR)+(0,.05cm)$)
           and($(TL)!.60!(TR)-(0,\SH cm*.25)$)..
    ($(TL)!.67!(TR)-(0,\SH cm*.10)$)
    ..controls($(TL)!.74!(TR)+(0,.08cm)$)
           and($(TL)!.82!(TR)-(0,\SH cm*.22)$)..
    ($(TL)!.88!(TR)-(0,\SH cm*.08)$)
    ..controls($(TL)!.94!(TR)+(0,.04cm)$)..
    ($(TR)-(0,\SH cm*.20)$)
    --($(TR)-(0,\SH cm)$)--($(TL)-(0,\SH cm)$)--cycle;
  \fill[Stone!40]
    ($(TL)-(0,\SH cm*.50)$)
    ..controls($(TL)!.06!(TR)-(0,\SH cm*.35)$)
           and($(TL)!.12!(TR)-(0,\SH cm*.55)$)..
    ($(TL)!.18!(TR)-(0,\SH cm*.40)$)
    ..controls($(TL)!.25!(TR)-(0,\SH cm*.28)$)
           and($(TL)!.32!(TR)-(0,\SH cm*.58)$)..
    ($(TL)!.40!(TR)-(0,\SH cm*.42)$)
    ..controls($(TL)!.48!(TR)-(0,\SH cm*.30)$)
           and($(TL)!.55!(TR)-(0,\SH cm*.60)$)..
    ($(TL)!.62!(TR)-(0,\SH cm*.45)$)
    ..controls($(TL)!.70!(TR)-(0,\SH cm*.32)$)
           and($(TL)!.78!(TR)-(0,\SH cm*.56)$)..
    ($(TL)!.85!(TR)-(0,\SH cm*.40)$)
    ..controls($(TL)!.92!(TR)-(0,\SH cm*.28)$)..
    ($(TR)-(0,\SH cm*.48)$)
    --($(TR)-(0,\SH cm)$)--($(TL)-(0,\SH cm)$)--cycle;
  \fill[Stone!65]
    ($(TL)-(0,\SH cm*.70)$)
...
% ── Dispatcher: calls the active landscape body ──
...
\newcommand{\HeaderStrip}{%
  \begin{tikzpicture}[remember picture, overlay]
    ...
    % Landscape silhouette — drawn by \ActiveLandscapeBody
    % Change \ActiveLandscape in the config block to switch scenes.
    \ActiveLandscapeBody
